...
var circleType = require('./circletype.min.js');
...
tl_about_me.from('.img-about-me', {
  ...
  duration: .9,
  opacity: 0
}).from('.context-about-me p', {
  y: 100,
  duration: 1.1,
  opacity: 0
});
tl_portfolio.from('.col-first', {
  y: 125,
  duration: 1.1,
  opacity: 0,
  delay: .5
...
tl_contact_us.from('#circle-text', {
  y: 100,
  duration: 1.3,
  opacity: 0
}).from('.text-contact-us h4', {
  y: 50,
  duration: .5,
  opacity: 0
}).from('.text-contact-us h5', {
  y: 75,
  duration: .7,
  opacity: 0
});
...
new circleType(document.getElementById('circle-text')); // luxy.init();
...
smoothScroll();
},{"./luxy.js":"js/luxy.js","./circletype.min.js":"js/circletype.min.js"}],"../../../../Users/joni_/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["../../../../Users/joni_/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/script.js"], null)
